...
<div class="readme-content-test--hide-when-active">
  ...
  Open this lab in the Learn IDE, edit the file <code>edit-me.txt</code> in this lab using the Learn IDE, run the tests with > and submit the lab with <code>learn submit</code>.
